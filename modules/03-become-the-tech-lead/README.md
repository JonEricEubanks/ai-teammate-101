...
One delegated task is a demo. Three delegated tasks — running in parallel while you drink coffee — is a workflow. This module is about operating at that level: writing specs at speed, running multiple agent sessions concurrently, and reviewing AI output without becoming the bottleneck.

**Objectives.** By the end of this module you will be able to:

- Delegate multiple tasks in parallel without losing track of them
- Assign work from three different entry points (issue, Agents panel, VS Code)
- Apply a repeatable review rubric to AI-generated PRs
- Use Copilot *as a reviewer* — and know when that's not enough
